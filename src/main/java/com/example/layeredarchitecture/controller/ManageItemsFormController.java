...
import com.example.layeredarchitecture.bo.ManageItemBO;
import com.example.layeredarchitecture.bo.ManageItemBOImpl;
...
public class ManageItemsFormController {
    ...
    private void loadAllItems() {
        ...
        try {
            ...
            ArrayList<ItemDTO> itemList = manageItemBO.getAllItem();
    ...
    public void btnDelete_OnAction(ActionEvent actionEvent) {
        ...
        try {
            if (!manageItemBO.existItem(code)) {
                new Alert(Alert.AlertType.ERROR, "There is no such item associated with the id " + code).show();
            }

            manageItemBO.deleteItem(code);
    ...
    private String generateNewId() {
        try {
            return manageItemBO.generateItemID();
        } catch (SQLException e) {
